...
public class AsyncArrayProcessing {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("filtered array 1: " + Arrays.toString(array1));
        System.out.println("filtered array 2: " + Arrays.toString(array2));
        System.out.println("filtered array 3: " + Arrays.toString(array3));
